...
export type MatchResultState = "not-open" | "reportable" | "awaiting-confirmation" | "disputed" | "finalized" | "void";
...
const fixtureItems: MyMatchItem[] = [
  {
    ...
    competition: { kind: "tournament", competitionId: "t-101", title: "جام قهرمانان کرج", tournamentSlug: "karaj-champions-cup", roundLabel: "یک‌هشتم نهایی" },
    opponent: { participantId: "p-014", kind: "player", displayTag: "ArminFC" },
    venue: { gamingCenterId: "gc-01", name: "Arena Gaming Center", city: "کرج" },
    startsAt: "2026-09-12T19:30:00+03:30", timezone: "Asia/Tehran", formatLabel: "Best of 3",
    lifecycleState: "scheduled", checkInState: "open", resultState: "not-open", disputeState: "none", attention: "check-in", result: null,
  },
  {
    matchId: "m-202",
    game: { gameId: "tekken-8", name: "Tekken 8" },
    competition: { kind: "challenge", competitionId: "ch-210", title: "چالش مستقیم", roundLabel: null },
    opponent: { participantId: "p-032", kind: "player", displayTag: "RezaZ" },
    venue: { gamingCenterId: "gc-02", name: "Nova Gaming", city: "کرج" },
    startsAt: "2026-09-10T20:00:00+03:30", timezone: "Asia/Tehran", formatLabel: "Best of 5",
    lifecycleState: "ready", checkInState: "not-required", resultState: "not-open", disputeState: "none", attention: "none", result: null,
  },
  {
    matchId: "m-203",
    game: { gameId: "cs2", name: "Counter-Strike 2" },
    competition: { kind: "tournament", competitionId: "t-103", title: "CS2 Open Cup", tournamentSlug: "cs2-open-cup", roundLabel: "نیمه‌نهایی" },
    opponent: { participantId: "team-12", kind: "team", displayTag: "Shadow Core" },
    venue: { gamingCenterId: "gc-03", name: "Pixel House", city: "کرج" },
    startsAt: "2026-09-09T21:00:00+03:30", timezone: "Asia/Tehran", formatLabel: "Best of 3",
    lifecycleState: "live", checkInState: "completed", resultState: "not-open", disputeState: "none", attention: "none", result: null,
  },
  {
    matchId: "m-204",
    game: { gameId: "ea-fc-26", name: "EA FC 26" },
    competition: { kind: "tournament", competitionId: "t-110", title: "لیگ شبانه تهران", tournamentSlug: "tehran-night-league", roundLabel: "هفته ۴" },
    opponent: { participantId: "p-041", kind: "player", displayTag: "MiladPro" },
    venue: { gamingCenterId: "gc-04", name: "Next Level", city: "تهران" },
    startsAt: "2026-09-08T21:30:00+03:30", timezone: "Asia/Tehran", formatLabel: "1v1",
    lifecycleState: "awaiting-result", checkInState: "not-required", resultState: "reportable", disputeState: "none", attention: "submit-result", result: null,
  },
  {
    matchId: "m-205",
    ...
    venue: { gamingCenterId: "gc-01", name: "Arena Gaming Center", city: "کرج" },
    startsAt: "2026-09-07T18:00:00+03:30", timezone: "Asia/Tehran", formatLabel: "Best of 3",
    lifecycleState: "awaiting-confirmation", checkInState: "not-required", resultState: "awaiting-confirmation", disputeState: "none", attention: "confirm-result", result: null,
  },
  {
    matchId: "m-206",
    game: { gameId: "tekken-8", name: "Tekken 8" },
    competition: { kind: "tournament", competitionId: "t-104", title: "Fight Night — Tekken 8", tournamentSlug: "tekken-8-fight-night", roundLabel: "یک‌چهارم نهایی" },
    opponent: { participantId: "p-067", kind: "player", displayTag: "KianZ" },
    venue: { gamingCenterId: "gc-02", name: "Nova Gaming", city: "کرج" },
    startsAt: "2026-09-05T19:00:00+03:30", timezone: "Asia/Tehran", formatLabel: "Best of 5",
    lifecycleState: "disputed", checkInState: "completed", resultState: "disputed", disputeState: "under-review", attention: "dispute", result: null,
  },
  {
    matchId: "m-207",
    game: { gameId: "ea-fc-26", name: "EA FC 26" },
    competition: { kind: "tournament", competitionId: "t-108", title: "جام تابستانه کرج", tournamentSlug: "karaj-summer-cup", roundLabel: "رده‌بندی" },
    opponent: { participantId: "p-071", kind: "player", displayTag: "Pouya11" },
    venue: { gamingCenterId: "gc-05", name: "Game Zone", city: "تهران" },
    startsAt: "2026-08-30T18:30:00+03:30", timezone: "Asia/Tehran", formatLabel: "1v1",
    lifecycleState: "completed", checkInState: "completed", resultState: "finalized", disputeState: "none", attention: "none",
    result: { playerScore: 4, opponentScore: 1, outcome: "win", ratingDelta: 18, finalizedAt: "2026-08-30T19:15:00+03:30" },
  },
  {
    matchId: "m-208",
    game: { gameId: "ea-fc-26", name: "EA FC 26" },
    competition: { kind: "tournament", competitionId: "t-109", title: "EA FC Summer Final", tournamentSlug: "ea-fc-summer-final", roundLabel: "یک‌چهارم نهایی" },
    opponent: { participantId: "p-083", kind: "player", displayTag: "ArianX" },
    venue: { gamingCenterId: "gc-05", name: "Game Zone", city: "تهران" },
    startsAt: "2026-08-21T20:00:00+03:30", timezone: "Asia/Tehran", formatLabel: "1v1",
    lifecycleState: "completed", checkInState: "not-required", resultState: "finalized", disputeState: "resolved", attention: "none",
    result: { playerScore: 1, opponentScore: 2, outcome: "loss", ratingDelta: -11, finalizedAt: "2026-08-21T20:50:00+03:30" },
  },
  {
    matchId: "m-209",
    game: { gameId: "cs2", name: "Counter-Strike 2" },
    ...
    startsAt: "2026-08-18T16:00:00+03:30", timezone: "Asia/Tehran", formatLabel: "Best of 1",
    lifecycleState: "cancelled", checkInState: "not-open", resultState: "void", disputeState: "none", attention: "none", result: null,
  },
];
...
export class MockMyMatchesRepository implements MyMatchesRepository {
  async getMyMatches(query: MyMatchesQuery): Promise<MyMatchesPageData> {
    ...
    if (query.kind !== "all") filtered = filtered.filter((item) => item.competition.kind === query.kind);
    if (query.gameId) filtered = filtered.filter((item) => item.game.gameId === query.gameId);
