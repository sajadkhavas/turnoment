  ...
  return (
    <section className="container mx-auto px-4 py-14">
      <SectionHeading
        ...
        action={
          <Link to="/category/consoles" className="inline-flex shrink-0 items-center gap-1 rounded-lg px-3 py-2 text-xs font-bold text-primary transition-colors hover:bg-primary/10">
